  ...
  return (
    <nav className="fixed z-100 w-full px-8 md:px-12 lg:px-5 mix-blend-difference">
      <div className="flex items-center justify-between max-w-[1920px] mx-auto">
        <div className="cursor-pointer pt-6 text-lg md:text-xl uppercase font-medium font-mono text-white tracking-tight translate-y-[-0.15rem] w-148 border-b border-neutral-500 pl-2 pb-2">
          <Image src="/assets/ZackA.svg"  width={75} height={75} alt="logo" className="pb-2"/>
        </div>
        <div className="flex items-center font-mono gap-2 md:gap-4 lg:gap-4">
          {/* Whoami */}
          <div className="relative border-b border-neutral-500 hover:border-neutral-300 transitio-all duration-600 pt-2 pb-4 w-45">
          ...
          {/* Work */}
          <div className="relative border-b border-neutral-500 hover:border-neutral-300 duration-600 pt-2 pb-4 w-45">
          ...
          {/* Connect */}
          <div className="relative border-b border-neutral-500 hover:border-neutral-300 duration-600 pt-2 pb-4 w-60">
